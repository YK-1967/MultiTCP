...
Public Class FrmServer
    ...
    Function SendHexToClients(ByVal hex_byte() As Byte) As Boolean
        Try
            Dim nstm As Stream
            ...
            End If
        Catch ex As Exception
            RichTextBox1.Text += "SendToClients() Exception:" + ex.Message + vbNewLine
        End Try
        Return False
    End Function
    ...
    Private Sub BtnHex_Click(sender As Object, e As EventArgs) Handles BtnHex.Click
        ...
        If SendHexToClients(hex_byte) = True Then
            'txtHex.Clear()
        End If
    End Sub
    ...
    Private Sub FrmServer_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        BtnDisconnect.Enabled = False
        SckClient.Close()
    End Sub
